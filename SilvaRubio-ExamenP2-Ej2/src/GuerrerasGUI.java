...
public class GuerrerasGUI {
    ...
    private void actualizarTabla(JTable tabla, java.util.List<GuerreraBrightMoon> villanos) {
        String[] columnas = {"ID", "Alias", "Especialidad", "Nivel", "Ubicación"};
        String[][] datos = new String[villanos.size()][5];

        for (int i = 0; i < villanos.size(); i++) {
            GuerreraBrightMoon v = villanos.get(i);
